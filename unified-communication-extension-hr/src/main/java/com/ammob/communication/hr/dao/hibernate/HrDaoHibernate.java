...
public class HrDaoHibernate<T, PK extends Serializable> implements GenericDao<T, PK> {
     ...
     */
    public HrDaoHibernate(final Class<T> persistentClass) {
     ...
     */
    public HrDaoHibernate(final Class<T> persistentClass, SessionFactory sessionFactory) {
    	RoutingDataSource.setDetermineType(Constants.DEFAULT_DATASOUCE);
        this.persistentClass = persistentClass;
