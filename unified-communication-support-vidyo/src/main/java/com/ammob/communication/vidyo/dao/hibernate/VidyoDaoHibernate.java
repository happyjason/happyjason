...
import com.ammob.communication.core.util.HibernateSearchUtil;
 ...
 * <pre>
 *      &lt;bean id="fooDao" class="com.ammob.communication.core.dao.hibernate.GenericDaoHibernate"&gt;
 *          &lt;constructor-arg value="com.ammob.communication.core.model.Foo"/&gt;
 *      &lt;/bean&gt;
 * </pre>
...
public class VidyoDaoHibernate<T, PK extends Serializable> implements GenericDao<T, PK> {
     ...
     */
    public VidyoDaoHibernate(final Class<T> persistentClass) {
     ...
     */
    public VidyoDaoHibernate(final Class<T> persistentClass, SessionFactory sessionFactory) {
    	RoutingDataSource.setDetermineType(Constants.DEFAULT_DATASOUCE);
        this.persistentClass = persistentClass;
	...
	public List<T> search(String searchTerm) throws SearchException {
        ...
        try {
            qry = HibernateSearchUtil.generateQuery(searchTerm, this.persistentClass, sess, defaultAnalyzer);
