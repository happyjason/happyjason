...
import com.ammob.communication.webapp.form.FileUploadForm;
...
public class FileUploadController extends BaseFormController {
    ...
    public String onSubmit(FileUploadForm fileUpload, BindingResult errors, HttpServletRequest request)
            throws Exception {
