 ...
 * user and saving messages/errors. This class is intended to test2222
...
public class BaseFormController implements ServletContextAware {
	...
	public Map<String, Object> getConfiguration() {
		Map<String, Object> config = (Map<String, Object>) servletContext.getAttribute(Constants.CONFIG);
    ...
    protected void sendUserMessage(User user, String msg, String url) {
        ...
        message.setTo(user.getNickname() + "<" + user.getEmail() + ">");
