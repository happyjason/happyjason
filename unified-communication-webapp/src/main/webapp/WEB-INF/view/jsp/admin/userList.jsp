...
<div class="span10">
    ...
    <div id="actions" class="form-actions">
        <a class="btn btn-primary" href="<c:url value='/user/profile?method=Add&from=list'/>">
    ...
    <display:table name="userList" cellspacing="0" cellpadding="0" requestURI=""
        ...
        <display:column property="nickname" escapeXml="true" sortable="true" titleKey="userForm.nickname"
                        style="width: 34%"/>
