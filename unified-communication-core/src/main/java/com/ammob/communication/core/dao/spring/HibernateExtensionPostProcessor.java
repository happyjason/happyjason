package com.ammob.communication.core.dao.spring;
 ...
 * 
 * <pre>
 * &lt;bean class=&quot;com.ammob.communication.core.dao.spring.HibernateExtensionPostProcessor&quot;&gt;
 *     &lt;property name=&quot;mappingResources&quot;&gt;
 *         &lt;list&gt;
 *             &lt;value&gt;com/ammob/communication/model/Foo.hbm.xml&lt;/value&gt;
 *         &lt;/list&gt;
 *     &lt;/property&gt;
 *     &lt;property name=&quot;annotatedClasses&quot;&gt;
 *         &lt;list&gt;
 *             &lt;value&gt;com.ammob.communication.core.model.Bar&lt;/value&gt;
 *         &lt;/list&gt;
 *     &lt;/property&gt;
 * &lt;/bean&gt;
 * </pre>
    ...
    public void postProcessBeanFactory(ConfigurableListableBeanFactory configurableListableBeanFactory)  {
        if (configurableListableBeanFactory.containsBean(sessionFactoryBeanName)) {
            ...
            if (mappingResources != null) {
                ...
                List<Object> existingMappingResources = (List<Object>) propertyValue.getValue();
            ...
            if (configLocations != null) {
                ...
                List<Object> existingConfigLocations = (List<Object>) propertyValue.getValue();
