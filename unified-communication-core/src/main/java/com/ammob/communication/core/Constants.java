package com.ammob.communication.core;
...
public final class Constants {
    ...
    /**
     * The name of the CDR database user setting.
     */
    public static final String CDR_USERNAME = "cdraccess";
    
    /**
     * The name of the default dataSouce setting.
     */
    public final static String DEFAULT_DATASOUCE = "dataSource";
